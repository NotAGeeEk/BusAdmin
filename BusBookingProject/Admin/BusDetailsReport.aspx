                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:HyperLink ID="hlinkUpdate" runat="server" >Update Details</asp:HyperLink>
                                 ...
                                 <asp:LinkButton ID="lnkDelete" runat="server" href="http://localhost:1778/Admin/DeleteSchedule.aspx" CommandName="Delete" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this item?');" />
